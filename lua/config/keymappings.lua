...
-- fzflua
keymap("n", "<S-p>", "<CMD>lua require('fzf-lua').live_grep({resume=true}) <CR>",
  { desc = "Search keywords", silent = true })
...
keymap("n", "<leader>ss", "<CMD>lua require('fzf-lua').lsp_document_symbols()<CR>",
  { desc = "Search lsp_document_symbols", silent = true })
...
-- Obsidian
keymap("n", "<leader>ot", "<cmd>Obsidian template<CR>", { desc = "Obsidian Template", silent = true })
keymap("n", "<leader>on", "<cmd>Obsidian new<CR>", { desc = "Create New Note", silent = true })
keymap("n", "<leader>ob", "<cmd>Obsidian backlinks<CR>", { desc = "View Backlinks", silent = true })
keymap("v", "<leader>oc", "<cmd>Obsidian extract_note<CR>", { desc = "Extract text to new note", silent = true })
keymap("n", "<leader>ol", "<cmd>Obsidian links<CR>", { desc = "View Links", silent = true })
keymap("n", "<leader>oT", "<cmd>Obsidian tags<CR>", { desc = "Searching for Tags in Vault", silent = true })
-- based64
